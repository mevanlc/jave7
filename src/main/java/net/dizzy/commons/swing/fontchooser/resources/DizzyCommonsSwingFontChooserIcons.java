...
public final class DizzyCommonsSwingFontChooserIcons {
   private static final int ICON_SIZE = JavePreferences.readIconSizePreference();
   public static final Icon FONT_ICON = icon("font");

   private DizzyCommonsSwingFontChooserIcons() {
   }

   private static Icon icon(String name) {
      URL url = DizzyCommonsSwingFontChooserIcons.class.getResource(name + ".gif");
