...
public class DialogButtonConfiguration implements IDialogButtonConfiguration {
   static final ActionConfiguration DEFAULT_CANCEL_CONFIG = new ActionConfiguration(DisyCommonsSwingDialogMessages.CANCEL);
   static final ActionConfiguration DEFAULT_OK_CONFIG = new ActionConfiguration(DisyCommonsSwingDialogMessages.OK);
   ...
   public IActionConfiguration getOkActionConfiguration() {
      return this.okConfiguration;
   }

   @Override
   public IActionConfiguration getCancelActionConfiguration() {
      return this.cancelConfiguration;
   }
}
